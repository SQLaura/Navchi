...
COMMAND_LOVE_BUY_VALENTINE_BOOST = re.compile(rf'\b(?:love|valentine)\b\s+\bbuy\b\s+\bvalentine\b\s+\bboost\b')
COMMAND_LOVE_SHARE = re.compile(rf"(?:\blove\b|\bval\b|\bvalentine\b)\s+\bshare\b")
