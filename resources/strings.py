...
INTERNAL_ERROR_DICT_TO_OBJECT = (
    "Error converting record into object\nFunction: {function}\nRecord: {record}\n"
)
...
DEFAULT_MESSAGE_EVENT = "{name} Hey! The **{event}** event just finished! You can check the results in <# 604410216385085485>."
...
CLAN_LEADERBOARD_ROAST_ZERO_ENERGY = "<:amongus_sus:875996946903478292> There is one player among us that wants us to believe he is not an impostor."
